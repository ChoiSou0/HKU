...
public class RunPlayer : MonoBehaviour
{
	...
	void Start()
	{
		...
		Starttime = DateTime.Now.Hour * 3600 + DateTime.Now.Minute * 60 + DateTime.Now.Second;
	}
	...
	public void OnTriggerEnter2D(Collider2D collision)
	{
		if (collision.tag == "spike")
		{
			...
			if (GM.Distance <= 0)
			{
				...
				GM.IsGameover = true;
				StartCoroutine(Ending.GoEnding("Run", ((DateTime.Now.Hour * 3600 + DateTime.Now.Minute * 60 + DateTime.Now.Second) - Starttime), true, GM.FadeImage));
			}
		}
	}
}
